        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            {eligibilityChecklist.map((item) => {
              ...
              return (
                <div key={item.id} className="flex items-start gap-3 bg-orange-50 p-4 rounded-lg hover:bg-orange-100 transition-colors">
                        ...
                        {calculatorResult.eligible && (
                          <div className="grid md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-white p-4 rounded-lg shadow-sm md:col-span-2">
                              ...
                              <p className="text-lg font-bold text-orange-600">{calculatorResult.processingTime}</p>
              ...
              return (
                <div key={item.step} className="flex gap-4">
                  <div className="flex flex-col items-center">
                    <div className="bg-gradient-to-br from-orange-500 to-orange-600 text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg">
                      {item.step}
                    </div>
                    {index < refundTimeline.length - 1 && (
                      <div className="w-1 h-full bg-gradient-to-b from-orange-300 to-orange-400 my-2 rounded-full"></div>
                    )}
                  </div>
                  <div className="flex-1 pb-8">
                    <div className="bg-white p-5 rounded-lg shadow-md border-l-4 border-orange-600 hover:shadow-lg transition-shadow">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          <Icon className="w-5 h-5 text-orange-600" />
                          <h4 className="font-bold text-gray-900">{item.title}</h4>
                        </div>
                        <span className="text-sm bg-gradient-to-r from-orange-100 to-orange-200 text-orange-700 px-3 py-1 rounded-full font-semibold">
                          {item.time}
                        </span>
                      </div>
            ...
            <div className="space-y-3">
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <p className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="bg-orange-100 text-orange-700 w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold">1</span>
              ...
              <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <p className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="bg-orange-100 text-orange-700 w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold">2</span>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-5 rounded-lg border-2 border-orange-200">
            <h4 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white p-5 rounded-lg shadow-md border-t-4 border-orange-600 hover:shadow-lg transition-shadow">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-50 p-5 rounded-lg border-l-4 border-gray-400">
              ...
              <ol className="space-y-2 text-sm text-gray-700 list-decimal pl-5">
                <li>Contact our Returns Manager at <a href="mailto:oshocksstores@gmail.com" className="text-orange-600 hover:underline font-semibold">oshocksstores@gmail.com</a></li>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-orange-50 p-6 rounded-lg border-2 border-orange-200">
            <h4 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
          ...
          <div className="bg-gray-50 p-5 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <div className="flex items-start gap-3 bg-white p-3 rounded">
                <span className="font-bold text-orange-600">v3.0</span>
                <div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow border-t-4 border-orange-600">
            <div className="text-4xl font-bold text-orange-600 mb-1">30</div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            {displaySections.map((section) => (
              <a
                key={section.id}
                href={`#${section.id}`}
                className="flex items-center gap-2 text-orange-600 hover:text-orange-800 hover:underline transition-colors p-2 rounded hover:bg-orange-50"
                onClick={(e) => {
                  e.preventDefault();
        ...
        {/* CTA Section */}
        <div className="mt-12 bg-gray-900 p-8 rounded-lg shadow-xl text-white relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-orange-600 px-8 py-3 rounded-lg font-bold hover:bg-orange-50 transition-colors shadow-md flex items-center justify-center gap-2">
                <RotateCcw className="w-5 h-5" />
                Start Return Request
              </button>
              <button className="bg-orange-700 text-white px-8 py-3 rounded-lg font-bold hover:bg-orange-800 transition-colors shadow-md border-2 border-white flex items-center justify-center gap-2">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <a href="/shipping-policy" className="text-orange-600 hover:underline font-semibold text-sm flex items-center gap-1">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <a href="/refund-policy" className="text-orange-600 hover:underline font-semibold text-sm flex items-center gap-1">
              Read More <ArrowRight className="w-4 h-4" />
            </a>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <a href="/help" className="text-orange-600 hover:underline font-semibold text-sm flex items-center gap-1">
        ...
        {/* Footer Note commented out - using global Footer component instead
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <button className="bg-gradient-to-br from-orange-500 to-orange-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110">
