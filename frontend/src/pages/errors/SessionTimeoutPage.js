            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-200 rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="text-sm text-orange-500 hover:text-orange-700 font-semibold transition-colors"
                >
                  Cancel
                </button>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div className="text-3xl font-bold text-orange-500 min-w-[80px] text-right">
        ...
        <div className="max-w-4xl mx-auto mb-6">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                onClick={handleLogin}
                className="flex items-center justify-center space-x-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-4 rounded-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-md hover:shadow-lg group"
              >
            ...
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-600">
                ...
                <a href="/register" className="text-green-600 hover:text-green-800 font-semibold ml-1 transition-colors">
                  Sign Up Free
                </a>
              </p>
            </div>
