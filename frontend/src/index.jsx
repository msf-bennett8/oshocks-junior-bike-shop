...
function registerServiceWorker() {
  ...
  // In Vite dev mode, the PWA plugin handles SW registration automatically
  // Only register manually in production builds
  if (import.meta.env.DEV) {
    console.log('🔧 Dev mode: Service Worker handled by Vite PWA plugin');
    return;
  }
...
function initializeApp() {
  ...
  if (import.meta.env.DEV) {
    ...
    window.__APP_VERSION__ = import.meta.env.VITE_APP_VERSION || '1.0.0';
...
// Vite handles HMR automatically — no manual module.hot needed
// HMR is provided by @vitejs/plugin-react-swc out of the box
