...
const EventsModerationPage = () => {
  ...
  const openQuoteModal = (ride) => {
    ...
    setQuoteForm({
      ...
      base_rental_adjustment_note: ride.base_rental_adjustment_note || '',
      add_ons_adjustment_note: ride.add_ons_adjustment_note || '',
      insurance_adjustment_note: ride.insurance_adjustment_note || '',
      transport_adjustment_note: ride.transport_adjustment_note || '',
      security_deposit_adjustment_note: ride.security_deposit_adjustment_note || '',
      total_price_adjustment_note: ride.total_price_adjustment_note || '',
      general_adjustment_notes: ride.general_adjustment_notes || '',
  ...
  useEffect(() => {
    ...
    // Only auto-update if the user hasn't manually overridden the total
    // or if the total is empty/0
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-6 my-8">
            ...
            <p className="text-gray-600 text-sm mb-4">
              Review original pricing and set adjusted values for <strong>{selectedEvent.title}</strong>
            </p>
            ...
            <div className="space-y-4 mb-4 max-h-[60vh] overflow-y-auto pr-2">
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Original: <span className="line-through text-gray-400 mr-1">KSh {Number(selectedEvent.base_rental_price || 0).toLocaleString()}</span>
                    {Number(quoteForm.base_rental_price || 0) !== Number(selectedEvent.base_rental_price || 0) && (
                      <span className="text-green-600 font-semibold">
                        → KSh {Number(quoteForm.base_rental_price || 0).toLocaleString()}
                      </span>
                    )}
                  </span>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Original: <span className="line-through text-gray-400 mr-1">KSh {Number(selectedEvent.add_ons_price || 0).toLocaleString()}</span>
                    {Number(quoteForm.add_ons_price || 0) !== Number(selectedEvent.add_ons_price || 0) && (
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Original: <span className="line-through text-gray-400 mr-1">KSh {Number(selectedEvent.insurance_price || 0).toLocaleString()}</span>
                    {Number(quoteForm.insurance_price || 0) !== Number(selectedEvent.insurance_price || 0) && (
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Original: <span className="line-through text-gray-400 mr-1">KSh {Number(selectedEvent.transport_price || 0).toLocaleString()}</span>
                    {Number(quoteForm.transport_price || 0) !== Number(selectedEvent.transport_price || 0) && (
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Original: <span className="line-through text-gray-400 mr-1">KSh {Number(selectedEvent.security_deposit || 0).toLocaleString()}</span>
                    {Number(quoteForm.security_deposit || 0) !== Number(selectedEvent.security_deposit || 0) && (
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="text-right">
                    <span className="text-xs text-orange-600 block">
                      Original: <span className="line-through text-orange-400 mr-1">KSh {Number(selectedEvent.total_price || 0).toLocaleString()}</span>
                    </span>
