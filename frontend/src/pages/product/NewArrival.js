...
import { Sparkles, Heart, ShoppingCart, Filter, Star, TrendingUp, Package, Shield, Truck, Search, Grid, List, SlidersHorizontal, X, ArrowRight, Clock, Zap, Award, Eye, Bell, Mail, CheckCircle, ChevronDown } from 'lucide-react';
  ...
  const sampleProducts = [
    {
      ...
      brand: 'Trek',
      isNew: true,
      arrivalDate: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2), // 2 days ago
      stock: 8,
      rating: 4.9,
      reviews: 3,
...
export default NewArrivalsPage; className="flex items-center gap-2">
