      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 to-indigo-600">
        <div className="text-center text-white p-8">
          ...
          <p className="text-sm opacity-75">
            Expected completion: {import.meta.env.VITE_APP_MAINTENANCE_END || 'Soon'}
          </p>
        </div>
      </div>
    );
          ...
          <main className="flex-1">
            ...
            <PageTransition>
              <Routes>
                ...
                <Route path="/ride-created/:code" element={<RideCreatedSuccessPage />} />
                <Route path="/event-created/:code" element={<EventCreatedSuccessPage />} />
