...
const EventBookingPage = () => {
  ...
  const total = basePrice + bikeRentalPrice + bikeAddOnsPrice + bikeInsurancePrice + transportPrice + eventInsurancePrice + nutritionPrice;
                ...
                <div className="md:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
                  ...
                  <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-sm text-blue-700">
                        This is a demo booking page. In production, this will integrate with Paystack/M-Pesa.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-24">
                    ...
                    <div className="space-y-3 mb-4 pb-4 border-b border-gray-100">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium text-gray-900">KSh {basePrice.toLocaleString()}</span>
                      </div>
                      {bikeRentalPrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Bike Rental ({selectedBike?.name})</span>
                          <span className="font-medium text-gray-900">KSh {bikeRentalPrice.toLocaleString()}</span>
                        </div>
                      )}
                      {bikeAddOnsPrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Bike Equipment</span>
                          <span className="font-medium text-gray-900">KSh {bikeAddOnsPrice.toLocaleString()}</span>
                        </div>
                      )}
                      {bikeInsurancePrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Bike Insurance</span>
                          <span className="font-medium text-gray-900">KSh {bikeInsurancePrice.toLocaleString()}</span>
                        </div>
                      )}
                      {transportPrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Transport</span>
                          <span className="font-medium text-gray-900">KSh {transportPrice.toLocaleString()}</span>
                        </div>
                      )}
                      {eventInsurancePrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Insurance</span>
                          <span className="font-medium text-gray-900">KSh {eventInsurancePrice.toLocaleString()}</span>
                        </div>
                      )}
                      {nutritionPrice > 0 && (
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Nutrition</span>
                          <span className="font-medium text-gray-900">KSh {nutritionPrice.toLocaleString()}</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-orange-600">KSh {total.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </div>
