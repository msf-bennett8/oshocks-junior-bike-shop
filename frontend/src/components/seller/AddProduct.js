...
import {
  Upload, X, Image as ImageIcon, Save, Eye, ArrowLeft, AlertCircle,
  Check, Plus, Minus, Tag, Package, DollarSign, Layers, MapPin,
  Truck, Info, Star, Clock, FileText, Zap, ImagePlus, Trash2
} from 'lucide-react';
